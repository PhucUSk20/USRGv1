...
public abstract class MLVideoHelperActivity extends AppCompatActivity {
     ...
     * streaming.
     * * Bộ dò tìm khuôn mặt cung cấp các giới hạn khuôn mặt có tọa độ, chiều rộng và chiều cao phụ thuộc vào
     *  chiều rộng và chiều cao của bản xem trước, được đảm bảo khả dụng sau khi bắt đầu xem trước
     *  phát trực tuyến.
     */
